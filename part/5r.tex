...
\subsection{Measurement for Mass}
...
\begin{table}[H]
	...
	equivalent mass		$M_{0} = m_{I-obj} + \frac{1}{3} m_{spr1} + \frac{1}{3} m_{spr2} $ & 184.13 \\ \hline
	equivalent mass		$M_{1} = m_{U-obj} + \frac{1}{3} m_{spr1} + \frac{1}{3} m_{spr2} $ & 195.42 \\ \hline
	\end{tabular}
	\caption{Mass measurement data}
	\label{measurementOfMass}
\end{table}
...
\begin{table}[H]
	...
	$m_1$ = 181.52  & 1.25604 \\ \hline
	$m_2$ = 186.19  & 1.27182 \\ \hline
	$m_3$ = 191.04  & 1.28784 \\ \hline
	$m_4$ = 195.86  & 1.30212 \\ \hline
	$m_5$ = 200.67  & 1.31892 \\ \hline
	$m_6$ = 205.38  & 1.33265 \\ \hline
	\end{tabular}
	\caption{$T^2$ vs. $M$ for horizontal situation}
	\label{T2vsM_0}
\end{table}

Thus, for incline 1 situation, we can get the following table.
...
\begin{table}[H]
	...
	\hline
	mass [g] $\pm$ 0.01 [g] & $T^2$ [$s^2$] $\pm$ 0.00001 [$s^2$] \\ \hline
	$m_1$ = 181.52  & 1.25578 \\ \hline
	$m_2$ = 186.19  & 1.27111 \\ \hline
	$m_3$ = 191.04  & 1.28722 \\ \hline
	$m_4$ = 195.86  & 1.30303 \\ \hline
	$m_5$ = 200.67  & 1.31860 \\ \hline
	$m_6$ = 205.38  & 1.33333 \\ \hline
	\end{tabular}
	\caption{$T^2$ vs. $M$ for incline 1 situation}
	\label{T2vsM_1}
\end{table}

Thus, for incline 2 situation, we can get the following table.
...
\begin{table}[H]
	...
	\hline
	mass [g] $\pm$ 0.01 [g] & $T^2$ [$s^2$] $\pm$ 0.00001 [$s^2$] \\ \hline
	$m_1$ = 181.52  & 1.25609 \\ \hline
	$m_2$ = 186.19  & 1.27220 \\ \hline
	$m_3$ = 191.04  & 1.28859 \\ \hline
	$m_4$ = 195.86  & 1.30347 \\ \hline
	$m_5$ = 200.67  & 1.31792 \\ \hline
	$m_6$ = 205.38  & 1.33369 \\ \hline
	\end{tabular}

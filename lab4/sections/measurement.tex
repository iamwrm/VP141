...
\subsection{Resonance method}
    \begin{enumerate}
        ...
        \begin{enumerate}[(1)]
            ...
            \item Adjust Signal Strength until a $10V$ peak voltage is observed on the oscilloscope.
            \item Adjust Signal Frequency between 34.5 kHz and 40 kHz until the peak-to-peak voltage reaches its maximum. Record the frequency.
        \end{enumerate}
